<?php /*a:1:{s:58:"D:\phpstudy_pro\WWW\application\index\view\user\login.html";i:1642481599;}*/ ?>
<!DOCTYPE html><html data-dpr="1"><head><meta http-equiv="Content-Type"
        ...
        href="/static_new/less/public.less"><script charset="utf-8"
          ...
          src="/static_new/js/common.js"></script></head><body><div id="app"><section class="title">      Sign in
           ...
           onclick="window.location.href=`/index/user/register`">Register</div></section></div></body><script type="application/javascript">  window.onload = () => {
    /*检查表单*/
    function check() {
