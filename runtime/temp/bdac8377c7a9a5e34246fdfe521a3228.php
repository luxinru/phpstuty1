<?php /*a:1:{s:58:"D:\phpstudy_pro\WWW\application\index\view\user\login.html";i:1615774298;}*/ ?>
<!DOCTYPE html><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo htmlentities(app('lang')->get('login')); ?></title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><link rel="stylesheet" href="/static_new/css/public.css"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><style type="text/css" title="fading circle style">        .circle-color-23 > div::before {
            background-color: #ccc;
        }
    </style></head><body style="font-size: 12px;"><div id="app"><!--<?php echo htmlentities($lang); ?>--><div data-v-c38e8882="" class="main" style="background:linear-gradient(to bottom, #95B8F7 30%, #F6F8FE)!important; background-repeat: no-repeat;background-size: 100% auto;"><!-- 头部图片 --><div style="width: 100px;height: 100px;position: absolute;margin-left: 3.5rem;margin-top: -2rem;"><img src="/img/MVP-logo.png" alt="" style="width: 100%;height: 100%;background-size: 100% 100%;"></div><div class="foo50" style="float: right;"><select class="lang"><option value="th-th" <?php if($lang=='th-th'): ?>selected<?php endif; ?> >ไทย </option><option value="en-us" <?php if($lang=='en-us'): ?>selected<?php endif; ?>>English</option><option value="zh-cn" <?php if($lang=='zh-cn'): ?>selected<?php endif; ?> >中文</option><option value="jp-jp" <?php if($lang=='jp-jp'): ?>selected<?php endif; ?> >日本語</option></select><script>     /*语言切换*/
