<?php /*a:1:{s:57:"D:\phpstudy_pro\WWW\application\index\view\my\invite.html";i:1615598992;}*/ ?>
<!DOCTYPE html><!-- saved from url=(0039)http://qiang6-www.baomiche.com/#/Poster --><html data-dpr="1" style="font-size: 45px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo lang('推广海报'); ?></title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/dialog.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><link rel="stylesheet" href="/static_new/css/public.css"><style type="text/css" title="fading circle style">        .circle-color-8 > div::before {
            background-color: #ccc;
        }
    </style></head><body style="font-size: 12px;"><div id="app"><div data-v-dc85d3de="" class="main" style="margin-top: -30px;background:rgb(217,15,24);"><div data-v-dc85d3de="" class="header"><div class="left_btn" onclick="window.history.back(-1)"><img
