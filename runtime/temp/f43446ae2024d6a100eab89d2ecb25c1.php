<?php /*a:2:{s:59:"E:\phpstudy_pro\WWW\application\index\view\my\downsoft.html";i:1642511671;s:60:"E:\phpstudy_pro\WWW\application\index\view\public\floor.html";i:1642511671;}*/ ?>
<!DOCTYPE html><!-- saved from url=(0041)http://qiang6-www.baomiche.com/#/TeamList --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo lang('团队报表'); ?></title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><script charset="utf-8" src="/static_new6/js/rolldate.js"></script><link rel="stylesheet" href="/static_new6/css/rolldate.css"><style type="text/css" title="fading circle style">        .circle-color-8 > div::before {
    ...
    *{
	...
	.btn_cont>div>a>p:last-child {
	    ...
	    /* margin-left: 2%; */
    ...
    </style></head><body style="font-size: 12px;"><div id="app"><div data-v-b7e8b406="" class="main"><!-- 头部导航 --><div data-v-b7e8b406="" class="header"><div class="left_btn" onclick="window.history.back(-1)"><img
                    ...
                    alt="" class="return"></div><div class="Maintitle"><h3><?php echo lang('download App'); ?></h3></div><div class="right_btn"></div></div><!-- 中间内容 --><div class="container"><div class="logo"><img src="/image-self/download/MVP-logo.png" alt=""></div><div class="btn_cont"><div class="ios"><a href="<?php echo htmlentities($app_url); ?>"><p class="icon-ios" style="width: 1rem;"><img src="/image-self/download/ios.png" alt=""></p><p>iPhone Download</p></a></div><div class="ard" style="background:#78bc43;"><a href="<?php echo htmlentities($app_url); ?>"><p class="icon-anzhuo" style="width: 1rem;"><img src="/image-self/download/ard.png" alt=""></p><p>Android Download</p></a></div></div></div><div data-v-8755e8fe="" data-v-eebac136="" class="footer"  style="background: none;width: 100%;height: 1.7rem;background-color: white;"><ul data-v-8755e8fe=""><li onclick="window.location.href='<?php echo url('index/home'); ?>'" data-v-8755e8fe=""><?php
